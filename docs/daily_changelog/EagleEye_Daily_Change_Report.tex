...
\date{Report revised: 19 May 2026 \\ \small Synced through the May 2026 model and hard-negative capture work on \texttt{main}}

\begin{document}
\maketitle

\begin{abstract}
This document records project evolution in a professional, date-ordered format. Entries follow \texttt{git log} on \texttt{main}. The May 2026 additions now cover the model-training layout, hard-negative collection, knowledge distillation experiments, Edge Impulse grayscale testing, and the firmware/runtime lessons learned while moving from lab training to ESP32-CAM validation.
\end{abstract}
