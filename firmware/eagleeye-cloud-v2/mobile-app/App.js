...
import SoundTestScreen from './src/screens/SoundTestScreen'; // SOUND TEST (removable)
        ...
        <SafeAreaProvider>
            <NavigationContainer>
                <Tab.Navigator
                    screenOptions={({ route }) => ({
                        ...
                        tabBarIcon: ({ focused, color, size }) => {
                            ...
                            } else if (route.name === 'Sound') {            // SOUND TEST (removable)
                ...
                >
                    ...
                    <Tab.Screen name="Sound" component={SoundTestScreen} />{/* SOUND TEST (removable) */}
