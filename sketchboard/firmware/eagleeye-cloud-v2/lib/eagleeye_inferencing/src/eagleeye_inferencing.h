...
#ifndef _EE_INFERENCE_H
#define _EE_INFERENCE_H
...
/* Includes ---------------------------------------------------------------- */
#include "eagleeye-sdk/classifier/ei_run_classifier.h"
#include "eagleeye-sdk/dsp/numpy.hpp"
#include "model-parameters/model_metadata.h"
#include "eagleeye-sdk/classifier/ei_classifier_smooth.h"

extern void ei_printf(const char *format, ...);

#endif // _EE_INFERENCE_H
