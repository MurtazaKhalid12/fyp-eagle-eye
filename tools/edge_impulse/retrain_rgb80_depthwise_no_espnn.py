...
ZIP_PATH = OUT_DIR / "ei_arduino_library_rgb80_depthwise_no_espnn.zip"
UNPACK_DIR = OUT_DIR / "ei_arduino_library_rgb80_depthwise_no_espnn"
...
def main() -> None:
    ...
    rest_post("impulse", {
        "name": "EagleEye 80x80 RGB Depthwise CNN human",
    ...
    print("Step 5) Generate 80x80 RGB features...", flush=True)
    ...
    print("=" * 64, flush=True)
    print(" Depthwise-separable tiny CNN (RGB 80x80) — ESP-NN DISABLED", flush=True)
