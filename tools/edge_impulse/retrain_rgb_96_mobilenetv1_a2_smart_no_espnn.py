...
RAW_ZIP_PATH = OUT_DIR / "ei_arduino_library_rgb96_mobilenetv1_a2_raw.zip"
ZIP_PATH = OUT_DIR / "ei_arduino_library_rgb96_mobilenetv1_a2_no_espnn.zip"
UNPACK_DIR = OUT_DIR / "ei_arduino_library_rgb96_mobilenetv1_a2_no_espnn"
...
def main() -> None:
    ...
    rest_post("impulse", {
        "name": "EagleEye 96x96 RGB MobileNetV1 0.2 smart human",
        "inputBlocks": [{
    ...
    desc = (
        "Smart RGB96 MobileNetV1 0.2 INT8, 32-neuron head, dropout 0.25, "
