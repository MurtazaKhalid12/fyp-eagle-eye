...
ZIP_PATH = OUT_DIR / "ei_arduino_library_gray80_tinycnn_espnn.zip"
UNPACK_DIR = OUT_DIR / "ei_arduino_library_gray80_tinycnn_espnn"
...
def main() -> None:
    ...
    rest_post("impulse", {
        "name": "EagleEye 80x80 Grayscale Tiny CNN human",
        "inputBlocks": [{
    ...
    print("=" * 64, flush=True)
    print(" Tiny CNN (greyscale 80x80) Arduino library — ESP-NN ENABLED", flush=True)
