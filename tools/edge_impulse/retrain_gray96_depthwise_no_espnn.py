...
ZIP_PATH = OUT_DIR / "ei_arduino_library_gray96_depthwise_no_espnn.zip"
UNPACK_DIR = OUT_DIR / "ei_arduino_library_gray96_depthwise_no_espnn"
...
def main() -> None:
    ...
    rest_post("impulse", {
        "name": "EagleEye 96x96 Grayscale Depthwise CNN human",
    ...
    print("=" * 64, flush=True)
    print(" Depthwise-separable tiny CNN (Grayscale 96x96) — ESP-NN DISABLED", flush=True)
