...
ZIP_PATH = OUT_DIR / "ei_arduino_library_gray96_tinycnn_reg_espnn.zip"
UNPACK_DIR = OUT_DIR / "ei_arduino_library_gray96_tinycnn_reg_espnn"
...
def main() -> None:
    ...
    rest_post("impulse", {
        "name": "EagleEye 96x96 Grayscale Tiny CNN regularized human",
        "inputBlocks": [{
