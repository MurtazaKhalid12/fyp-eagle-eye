...
RAW_ZIP_PATH = OUT_DIR / "ei_arduino_library_rgb64_mobilenetv1_a1_light_raw.zip"
ZIP_PATH = OUT_DIR / "ei_arduino_library_rgb64_mobilenetv1_a1_light_no_espnn.zip"
UNPACK_DIR = OUT_DIR / "ei_arduino_library_rgb64_mobilenetv1_a1_light_no_espnn"
...
def main() -> None:
    ...
    rest_post("impulse", {
        "name": "EagleEye 64x64 RGB MobileNetV1 0.1 light human",
        "inputBlocks": [{
    ...
    desc = (
        "Light RGB64 MobileNetV1 0.1 INT8, 16-neuron head, dropout 0.1, "
