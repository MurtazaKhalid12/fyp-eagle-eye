...
ZIP_PATH = OUT_DIR / "ei_arduino_library_gray80_tinycnn_light_espnn.zip"
UNPACK_DIR = OUT_DIR / "ei_arduino_library_gray80_tinycnn_light_espnn"

# Tiny conv net (NOT transfer learning).
VISUAL_LAYERS = [
    {"type": "conv2d", "neurons": 8,  "kernelSize": 3, "stack": 1, "enabled": True},
...
def main() -> None:
    ...
    rest_post("impulse", {
        "name": "EagleEye 80x80 Grayscale Tiny CNN light (8-16-16) human",
        "inputBlocks": [{
